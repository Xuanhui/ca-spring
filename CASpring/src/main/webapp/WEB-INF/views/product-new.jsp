...
<div class="tab-content profile-page">
	...
	action="${pageContext.request.contextPath}/product/create" class="form-horizontal" role="form">
			<fieldset>
				<h3>
		...
		<p class="text-center">
			...
			<input type="button" value="Cancel" class="btn btn-custom-primary" onclick="javascript:window.location.href ='/stockist-team6/product/list';">
		</p>
</form:form>
	</div>
</div>
